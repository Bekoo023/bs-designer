...
- [x] 03 Portfolio: twee heldere casestudies met eerlijke projectstatus, probleem, aanpak en techniek. Gebruik alleen bevestigde feiten. Vervang interpretaties door echte screenshots uitsluitend als die beschikbaar en toegestaan zijn.
  - 15 september: ClauseLens gekoppeld aan de openbare productpagina; Numico aan de openbare code. Handmatige boninvoer expliciet vermeld; automatische herkenning en chat niet als gerealiseerde functies beschreven. Illustraties blijven als interpretaties gelabeld.
  - 16 september: ClauseLens uitgelicht met echte publieke homepage- en detailscreenshots; Numico compact gemaakt. Bronnotities toegevoegd. Visuele beoordeling van de nieuwe portfolio en een mobiele productopname blijven open.
